...
SEARCH_URL = "https://pypistats.org/top"
...
def package(html):
    ...
    return [
        parse_package(article)
        for article in soup.find_all('div', class_='wrapper')
    ]

<a href="/packages/botocore">botocore</a>

def parse_package(article):
